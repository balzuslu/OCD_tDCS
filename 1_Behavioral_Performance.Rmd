...
# Calculate aggregated data per subject for boxplots and outlier detection
...
```
The groups differ in the feedback they received.
<br><br>
...
## For accuracy, post-error and post-correct accuracy we need the aggregated values as only for those we can make a histogram / q-q plot (to check normality for ANOVA)
