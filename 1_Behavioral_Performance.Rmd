...
names(single_trial_data_clean)[(ncol(single_trial_data_clean) - 7):ncol(single_trial_data_clean)] <- c("Grand Mean", "verum_sham", "OCD_HC", "incorrect_correct", "incongruent_congruent", "verum_sham:OCD_HC", "verum_sham:incorrect_correct", "verum_sham:incongruent_congruent")
...
GLMM_accuracy <- glmer(accuracy_numeric ~ verum_sham * (OCD_HC + incongruent_congruent + accuracy_prev_trial) +
  (1 + incongruent_congruent + verum_sham + verum_sham:incongruent_congruent  | participant_id),
data = single_trial_data_clean,
family = binomial,
