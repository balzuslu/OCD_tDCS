...
# Run model with maximal random-effects structure
GLMM_accuracy <- glmer(accuracy_numeric ~ verum_sham * OCD_HC * accuracy_prev_trial +
  (1 + verum_sham | participant_id),
data = single_trial_data_clean,
family = binomial,
control = glmerControl(optimizer = "bobyqa")
...
# Run model with maximal random-effects structure
GLMM_accuracy_group <- glmer(accuracy_numeric ~ group/stimulation * accuracy_prev_trial +
  (1 + verum_sham | participant_id),
data = single_trial_data_clean,
family = binomial,
control = glmerControl(optimizer = "bobyqa")
