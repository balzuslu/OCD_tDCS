...
plot_stimulation_by_group_resp_locked <- ggplot(resp_locked_data,aes(time, FCz)) +
  stat_summary(fun = mean, geom = "line", size = 0.5, linetype = "solid", aes(colour= stimulation:condition)) +
  geom_ribbon(data = CIs_group_stimulation_resp_locked, aes(ymin = FCz-ci, ymax = FCz+ci, fill = stimulation:condition), alpha = 0.15) + guides(fill = "none") +
  geom_vline(xintercept = 0, linetype = "dashed", colour="grey" ) +
  geom_hline(yintercept = 0, linetype = "dashed", colour="grey") +  
  geom_ribbon(aes(xmin=0, xmax=100), alpha=.2, fill="grey70") +
...
plot_group_by_stimulation_resp_locked <- ggplot(resp_locked_data,aes(time, FCz)) +
  ...
  geom_ribbon(data = CIs_group_stimulation_resp_locked, aes(ymin = FCz-ci, ymax = FCz+ci, fill = group:condition), alpha = 0.15) + guides(fill = "none") +
  geom_vline(xintercept = 0, linetype = "dashed", colour="grey" ) +
  geom_hline(yintercept = 0, linetype = "dashed", colour="grey") + 
  geom_ribbon(aes(xmin=0, xmax=100), alpha=.2, fill="grey70") +
  coord_cartesian(ylim=c(-10,10), xlim=c(-500,1000)) +
...
plot_stimulation_by_group_stim_locked <- ggplot(stim_locked_data,aes(time, CPz)) +
  stat_summary(fun = mean, geom = "line", size = 0.5, linetype = "solid", aes(colour= stimulation:condition)) +
  geom_ribbon(data = CIs_group_stimulation_stim_locked, aes(ymin = CPz-ci, ymax = CPz+ci, fill = stimulation:condition), alpha = 0.15) + guides(fill = "none") +
  geom_vline(xintercept = 0, linetype = "dashed", colour="grey" ) +
  geom_hline(yintercept = 0, linetype = "dashed", colour="grey") +  
  geom_ribbon(aes(xmin=200, xmax=295), alpha=.2, fill="grey70") +
  geom_ribbon(aes(xmin=305, xmax=500), alpha=.2, fill="grey70") +
  coord_cartesian(ylim=c(-4,12), xlim=c(-500,1000)) +
...
plot_group_by_stimulation_stim_locked <- ggplot(stim_locked_data,aes(time, CPz)) +
  stat_summary(fun = mean, geom = "line", size = 0.5, linetype = "solid", aes(colour= group:condition)) +
  geom_ribbon(data = CIs_group_stimulation_stim_locked, aes(ymin = CPz-ci, ymax = CPz+ci, fill = group:condition), alpha = 0.15) + guides(fill = "none") +
  geom_vline(xintercept = 0, linetype = "dashed", colour="grey" ) +
  geom_hline(yintercept = 0, linetype = "dashed", colour="grey") + 
  geom_ribbon(aes(xmin=200, xmax=295), alpha=.2, fill="grey70") +
  geom_ribbon(aes(xmin=305, xmax=500), alpha=.2, fill="grey70") +
...
# Save plot
ggsave("./figures/figure_ERP_trajectories_stim_locked.tiff", width = 14, height = 18, units = "cm", dpi=600, compression = "lzw")
