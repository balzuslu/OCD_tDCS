...
single_trial_data <- single_trial_data %>% 
  subset(select = c("name", "group", "session", "stimulation", "trial", "stimulus_type", "response_type", "rt1", "rt_log", "rt_invalid" ,"response_type_2nd", "rt2", "MFN_0_100_FCz", "MFN_.200_0_FCz", "Pe_200_400_Pz", "Pe_.200_0_Pz")) %>%
